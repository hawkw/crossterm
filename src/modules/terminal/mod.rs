...
pub use self::ansi_terminal::AnsiTerminal;
#[cfg(target_os = "windows")]
pub use self::winapi_terminal::WinApiTerminal;
...
pub trait ITerminal: Send+Sync {
    ...
    fn terminal_size(&self, screen_manager: &Arc<TerminalOutput>) -> (u16, u16);
    /// Scroll `n` lines up in the current terminal.
    fn scroll_up(&self, count: i16, screen_manager: &Arc<TerminalOutput>);
